...
class InitializerPluginLoadingTests < Test::Unit::TestCase
  ...
  def test_all_plugins_are_loaded_when_registered_plugin_list_is_untouched
    ...
    load_plugins!
    assert_plugins [:a, :acts_as_chunky_bacon, :engine, :gemlike, :plugin_with_no_lib_dir, defined?(Rails2Ruby2) ? :rails2_ruby2 : nil, :stubby].compact, @initializer.loaded_plugins, failure_tip
  end
  ...
  def test_all_plugins_loaded_when_all_is_used
    ...
    load_plugins!
    failure_tip = "It's likely someone has added a new plugin fixture without updating this list"
    assert_plugins [:stubby, :acts_as_chunky_bacon, :a, :engine, :gemlike, :plugin_with_no_lib_dir, defined?(Rails2Ruby2) ? :rails2_ruby2 : nil].compact, @initializer.loaded_plugins, failure_tip
  end
  ...
  def test_all_plugins_loaded_after_all
    ...
    load_plugins!
    failure_tip = "It's likely someone has added a new plugin fixture without updating this list"
    assert_plugins [:stubby, :a, :engine, :gemlike, :plugin_with_no_lib_dir, defined?(Rails2Ruby2) ? :rails2_ruby2 : nil, :acts_as_chunky_bacon].compact, @initializer.loaded_plugins, failure_tip
  end
